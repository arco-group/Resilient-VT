...
__all__ = ["predefined", "holdout", "multilabelholdout", "kfold", "stratifiedkfold", "multilabelstratifiedkfold", "leaveoneout", "bootstrap", "multilabelbootstrap"]
...
def multilabelholdout(data: np.array, labels: np.array, train_size: float = None,
             test_size: float = None, random_state: int = None, **kwargs) -> Tuple[ int, np.array, np.array ]:
    """
    Function to split data into train and test sets using holdout method.
    ...
    cv = MultilabelStratifiedShuffleSplit(n_splits=1, train_size=train_size, test_size=test_size, random_state=random_state)
...
def multilabelstratifiedkfold(data: np.array, labels: np.array, n_splits: int = 5, shuffle: bool = False, random_state: int = None, **kwargs) -> Tuple[ int, np.array, np.array ]:
    """
    Function that performs stratified k-fold cross-validation.
    ...
    test_index: np.ndarray.
        The testing set indices for that split.
    """
    cv = MultilabelStratifiedKFold(n_splits=n_splits, shuffle=shuffle, random_state=random_state)
...
def multilabelbootstrap(data: np.array, labels: np.array, n_splits: int = 5, train_size: float = None, test_size: float = None, random_state: int = None, stratify: bool = False, **kwargs) -> Tuple[ int, np.array, np.array ]:
    """
    This function generates a bootstrapped train/test split of the data and labels.
    ...
    cv = MultilabelStratifiedShuffleSplit(n_splits=n_splits, train_size=train_size, test_size=test_size, random_state=random_state)
