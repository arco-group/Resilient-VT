...
__all__ = ["get_preprocessing_params", "get_imaging_preprocessing_params", "get_columns_lists_by_type", "get_unique_values"]
...
def get_imaging_preprocessing_params(columns_info: pd.Series, preprocessing: Union[dict, DictConfig]) -> dict:
    """
    Get the preprocessing parameters for imaging datasets.
    Parameters
    ----------
    ...
    dict
        Preprocessing parameters.
    """
    output = dict( columns_info=columns_info, **preprocessing)
    return output
